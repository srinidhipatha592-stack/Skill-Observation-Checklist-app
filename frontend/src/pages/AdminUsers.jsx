    ...
    <div style={styles.root}>
      ...
      <main style={styles.main}>
        <header style={styles.header}>
          ...
          <p style={styles.pageSub}>View, search, and manage all users in the system.</p>
        </header>

        <div style={styles.contentPlaceholder}>
          <h2>User Management Module</h2>
          <p style={{ color: "#64748B", marginTop: "8px" }}>
            This module is currently a placeholder. Full implementation (CRUD, filtering, and role management) will be added in future phases.
          </p>
        </div>
      </main>
    </div>
